...
class Property(models.Model) :
    ...
    picture_1 = models.ImageField(upload_to="property_images")
    picture_2 = models.ImageField(blank=True, null=True, upload_to="property_images")
    picture_3 = models.ImageField(blank=True, null=True, upload_to="property_images")
    picture_4 = models.ImageField(blank=True, null=True, upload_to="property_images")
